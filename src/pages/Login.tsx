...
import { CircleUser, Mail, KeyRound, LogIn } from "lucide-react";
...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simulating authentication (will be replaced with actual auth)
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // For demo purposes, always succeed with any valid email format
