...
const LandingPage = () => {
  ...
  const [formData, setFormData] = useState<Partial<DocumentoLandingPage>>({
    nomeFundo: "",
    nomeAba: "",
    nomeArquivo: "",
    link: "",
  ...
  const toggleVisibility = (id: string) => {
    setDocumentos(
      documentos.map((documento) =>
        documento.id === id
          ? { ...documento, visivel: !documento.visivel }
          : documento
      )
    );
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Upload de documento para a landing page.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={formData.nomeAba || ""}
                onValueChange={(value) => handleSelectChange("nomeAba", value)}
              >
                <SelectTrigger>
              ...
              <div className="border rounded-md p-4 bg-gray-50">
                <div className="flex flex-col items-center justify-center gap-2">
                  ...
                  <div className="text-sm text-center text-gray-600">
                    ...
                    <label htmlFor="landing-file-upload" className="text-primary cursor-pointer hover:underline">
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={uploadingFile || !formData.nomeFundo || !formData.nomeAba || !formData.nomeArquivo}
            >
              {uploadingFile ? (
                <span className="flex items-center gap-2">
