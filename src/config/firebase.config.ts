...
// Configuração do segundo projeto (riza-asset-site)
const firebaseAssetManagementConfig = {
  apiKey: import.meta.env.REACT_APP_FIREBASE_API_KEY_ASSET_MANAGEMENT,
  authDomain: import.meta.env.REACT_APP_FIREBASE_AUTH_DOMAIN_ASSET_MANAGEMENT,
  projectId: 'riza-asset-management',
  storageBucket: import.meta.env.REACT_APP_FIREBASE_STORAGE_BUCKET_ASSET_MANAGEMENT,
  messagingSenderId: import.meta.env.REACT_APP_FIREBASE_MESSAGING_SENDER_ID_ASSET_MANAGEMENT,
  appId: import.meta.env.REACT_APP_FIREBASE_APP_ID_ASSET_MANAGEMENT,
  measurementId: import.meta.env.REACT_APP_FIREBASE_MEASUREMENT_ID_ASSET_MANAGEMENT,
};
...
const appAssetManagement = initializeApp(firebaseAssetManagementConfig, 'asset-management');
...
const firestoreAssetManagement = getFirestore(appAssetManagement);

// Exportar os serviços
export { firestoreIntranet, firestoreSite, firestoreAssetManagement };
